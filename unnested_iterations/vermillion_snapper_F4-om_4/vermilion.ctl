...
#C file write time: 2024-02-21 21:57:02.509667
#
...
#_Yr Input_value
1994 -0.674545990813371 #_stochastic_recdev_with_sigmaR=0.3
1995  0.525396187400582 #_stochastic_recdev_with_sigmaR=0.3
1996 -0.411002038003129 #_stochastic_recdev_with_sigmaR=0.3
1997 -0.234862357646875 #_stochastic_recdev_with_sigmaR=0.3
1998  0.00567641106854882 #_stochastic_recdev_with_sigmaR=0.3
1999  0.204135381082127 #_stochastic_recdev_with_sigmaR=0.3
2000  0.477465527931072 #_stochastic_recdev_with_sigmaR=0.3
2001  0.284009010842899 #_stochastic_recdev_with_sigmaR=0.3
2002  0.252484518935612 #_stochastic_recdev_with_sigmaR=0.3
2003 -0.333532525654328 #_stochastic_recdev_with_sigmaR=0.3
2004  0.0662834849553663 #_stochastic_recdev_with_sigmaR=0.3
2005 -0.366704303736983 #_stochastic_recdev_with_sigmaR=0.3
2006  0.185975298570326 #_stochastic_recdev_with_sigmaR=0.3
2007  0.139493618897239 #_stochastic_recdev_with_sigmaR=0.3
2008  0.251188158227056 #_stochastic_recdev_with_sigmaR=0.3
2009  0.121328501046703 #_stochastic_recdev_with_sigmaR=0.3
2010 -0.0479443561082298 #_stochastic_recdev_with_sigmaR=0.3
2011 -0.163480254657117 #_stochastic_recdev_with_sigmaR=0.3
2012 -0.215956505840763 #_stochastic_recdev_with_sigmaR=0.3
2013  0.301150406873145 #_stochastic_recdev_with_sigmaR=0.3
2014 -0.32614940031995 #_stochastic_recdev_with_sigmaR=0.3
2015 -0.107180877501797 #_stochastic_recdev_with_sigmaR=0.3
2016 -0.0938198052812762 #_stochastic_recdev_with_sigmaR=0.3
2017  0.160591909733145 #_stochastic_recdev_with_sigmaR=0.3
...
#_Fleet	start_F	first_parm_phase
    1	0.01	2	#_F_4_Fleet_Parms1
    2	0.01	2	#_F_4_Fleet_Parms2
    3	0.01	2	#_F_4_Fleet_Parms3
    4	0.01	1	#_F_4_Fleet_Parms4
...
#_LO	HI	INIT	PRIOR	PR_SD	PR_type	PHASE	env-var	use_dev	dev_mnyr	dev_mxyr	dev_PH	Block	Blk_Fxn  #  parm_name
-25	25	-8.91224	0	1	0	-1	0	0	0	0	0	0	0	#_LnQ_base_CM_E(1)   
-25	25	-8.55918	0	1	0	-1	0	0	0	0	0	0	0	#_LnQ_base_CM_W(2)   
-25	25	 -9.5031	0	1	0	-1	0	0	0	0	0	0	0	#_LnQ_base_REC(3)    
-10	20	 1.38481	0	0	0	 2	0	0	0	0	0	0	0	#_LnQ_base_SMP_BYC(4)
-25	25	-9.88309	0	1	0	-1	0	0	0	0	0	0	0	#_LnQ_base_HB_E(5)   
-25	25	-9.80357	0	1	0	-1	0	0	0	0	0	0	0	#_LnQ_base_HB_W(6)   
-27	25	-26.2165	0	1	0	-1	0	0	0	0	0	0	0	#_LnQ_base_LARVAL(7) 
-25	25	-10.4736	0	1	0	-1	0	0	0	0	0	0	0	#_LnQ_base_VIDEO(8)  
-25	25	-10.5629	0	1	0	-1	0	0	0	0	0	0	0	#_LnQ_base_SEAMAP(9) 
...
#_AgeSelex
  ...
  -10	    3	-9.16507	  -4.6	0.05	0	 3	0	0	0	0	0.5	0	0	#_AgeSel_P_2_REC(3)    

...
#_Yr Input_value
1971 -0.288176537283919 #_stochastic_recdev_with_sigmaR=0.6
1972 -0.341337607447737 #_stochastic_recdev_with_sigmaR=0.6
1973  0.490227788058863 #_stochastic_recdev_with_sigmaR=0.6
1974 -1.41064175984592 #_stochastic_recdev_with_sigmaR=0.6
1975  0.948350234118557 #_stochastic_recdev_with_sigmaR=0.6
1976  0.976351623033731 #_stochastic_recdev_with_sigmaR=0.6
1977 -0.310034216918127 #_stochastic_recdev_with_sigmaR=0.6
1978 -0.614478431263687 #_stochastic_recdev_with_sigmaR=0.6
1979  0.775433455708182 #_stochastic_recdev_with_sigmaR=0.6
1980  0.362066581521491 #_stochastic_recdev_with_sigmaR=0.6
1981  0.0915694539368718 #_stochastic_recdev_with_sigmaR=0.6
1982  0.464399940684745 #_stochastic_recdev_with_sigmaR=0.6
1983  0.374847143506545 #_stochastic_recdev_with_sigmaR=0.6
1984  0.915106878658583 #_stochastic_recdev_with_sigmaR=0.6
1985 -1.11933483298223 #_stochastic_recdev_with_sigmaR=0.6
1986 -0.564249794211988 #_stochastic_recdev_with_sigmaR=0.6
1987 -0.00171169045938698 #_stochastic_recdev_with_sigmaR=0.6
1988  0.782952250267748 #_stochastic_recdev_with_sigmaR=0.6
1989 -0.929207152084266 #_stochastic_recdev_with_sigmaR=0.6
1990  0.0280979462309056 #_stochastic_recdev_with_sigmaR=0.6
1991 -0.273656121572504 #_stochastic_recdev_with_sigmaR=0.6
1992  0.246715216272521 #_stochastic_recdev_with_sigmaR=0.6
1993 -0.0946316408015918 #_stochastic_recdev_with_sigmaR=0.6
1994 -0.50275219362592 #_stochastic_recdev_with_sigmaR=0.6
1995 -0.135985930541264 #_stochastic_recdev_with_sigmaR=0.6
1996 -0.289308380947961 #_stochastic_recdev_with_sigmaR=0.6
1997  0.368313582862061 #_stochastic_recdev_with_sigmaR=0.6
1998  0.0562369250847737 #_stochastic_recdev_with_sigmaR=0.6
1999 -0.435693135239232 #_stochastic_recdev_with_sigmaR=0.6
2000  0.479834429930956 #_stochastic_recdev_with_sigmaR=0.6
2001 -0.0493040246507956 #_stochastic_recdev_with_sigmaR=0.6
...
#_LO	HI	INIT	PRIOR	PR_SD	PR_type	PHASE	env-var	use_dev	dev_mnyr	dev_mxyr	dev_PH	Block	Blk_Fxn  #  parm_name
 -7	  5	0.141713	   0	1	0	-1	0	0	0	0	0	0	0	#_LnQ_base_SURV_A1(2)   
  0	0.5	0.243043	0.05	1	0	 4	0	0	0	0	0	0	0	#_Q_extraSD_SURV_A1(2)  
-11	  5	-9.37057	   0	1	0	-1	0	0	0	0	0	0	0	#_LnQ_base_RECRSVY_A1(3)
 -7	  5	 0.15639	   0	1	0	-1	0	0	0	0	0	0	0	#_LnQ_base_SURV_A2(5)   
  0	0.5	0.239072	0.05	1	0	 4	0	0	0	0	0	0	0	#_Q_extraSD_SURV_A2(5)  
-11	  5	-9.36089	   0	1	0	-1	0	0	0	0	0	0	0	#_LnQ_base_RECRSVY_A2(6)

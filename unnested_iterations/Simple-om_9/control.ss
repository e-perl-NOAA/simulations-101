...
#_Yr Input_value
1971  0.715482314130094 #_stochastic_recdev_with_sigmaR=0.6
1972 -0.0905590959144482 #_stochastic_recdev_with_sigmaR=0.6
1973 -0.692412382477855 #_stochastic_recdev_with_sigmaR=0.6
1974  0.0127714657146988 #_stochastic_recdev_with_sigmaR=0.6
1975 -0.715306460367249 #_stochastic_recdev_with_sigmaR=0.6
1976  0.472917735687176 #_stochastic_recdev_with_sigmaR=0.6
1977 -0.00459876212926294 #_stochastic_recdev_with_sigmaR=0.6
1978 -0.106275450936767 #_stochastic_recdev_with_sigmaR=0.6
1979  0.124689122684367 #_stochastic_recdev_with_sigmaR=0.6
1980  0.0900745455873262 #_stochastic_recdev_with_sigmaR=0.6
1981  0.498583707854017 #_stochastic_recdev_with_sigmaR=0.6
1982  0.190397342735753 #_stochastic_recdev_with_sigmaR=0.6
1983 -0.0178369005920648 #_stochastic_recdev_with_sigmaR=0.6
1984 -0.683763761044743 #_stochastic_recdev_with_sigmaR=0.6
1985 -0.82316218306533 #_stochastic_recdev_with_sigmaR=0.6
1986  0.329518778023955 #_stochastic_recdev_with_sigmaR=0.6
1987 -1.0798284984712 #_stochastic_recdev_with_sigmaR=0.6
1988 -0.518157514330725 #_stochastic_recdev_with_sigmaR=0.6
1989  0.775828114164829 #_stochastic_recdev_with_sigmaR=0.6
1990  0.700070332565689 #_stochastic_recdev_with_sigmaR=0.6
1991  0.394428974963677 #_stochastic_recdev_with_sigmaR=0.6
1992 -1.41190398669707 #_stochastic_recdev_with_sigmaR=0.6
1993 -0.599183504459208 #_stochastic_recdev_with_sigmaR=0.6
1994  0.368443135751144 #_stochastic_recdev_with_sigmaR=0.6
1995  0.722209242799126 #_stochastic_recdev_with_sigmaR=0.6
1996  0.605310478000085 #_stochastic_recdev_with_sigmaR=0.6
1997  0.0775101196179593 #_stochastic_recdev_with_sigmaR=0.6
1998  0.635043519078386 #_stochastic_recdev_with_sigmaR=0.6
1999 -0.706981371943506 #_stochastic_recdev_with_sigmaR=0.6
2000  0.0131474052001686 #_stochastic_recdev_with_sigmaR=0.6
2001  0.723543537870976 #_stochastic_recdev_with_sigmaR=0.6
...
#_LO	HI	INIT	PRIOR	PR_SD	PR_type	PHASE	env-var	use_dev	dev_mnyr	dev_mxyr	dev_PH	Block	Blk_Fxn  #  parm_name
-7	  5	0.516018	   0	1	0	 1	0	0	0	0	0	0	0	#_LnQ_base_SURVEY1(2) 
 0	0.5	       0	0.05	1	0	-4	0	0	0	0	0	0	0	#_Q_extraSD_SURVEY1(2)
-7	  5	 -6.6281	   0	1	0	 1	0	0	0	0	0	0	0	#_LnQ_base_SURVEY2(3) 
...
#_SizeSelex
#_LO	HI	INIT	PRIOR	PR_SD	PR_type	PHASE	env-var	use_dev	dev_mnyr	dev_mxyr	dev_PH	Block	Blk_Fxn  #  parm_name
  19	80	53.6411	50	0.01	1	2	0	0	0	0	0	0	0	#_SizeSel_P_1_FISHERY(1)
0.01	60	18.9232	15	0.01	1	3	0	0	0	0	0	0	0	#_SizeSel_P_2_FISHERY(1)
  19	70	 36.653	30	0.01	1	2	0	0	0	0	0	0	0	#_SizeSel_P_1_SURVEY1(2)

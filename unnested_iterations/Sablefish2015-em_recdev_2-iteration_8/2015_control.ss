...
#C file write time: 2024-04-29 17:20:12.093328
#
...
1959.8317 #_last_yr_nobias_adj_in_MPD; begin of ramp
1985 #_first_yr_fullbias_adj_in_MPD; begin of plateau
2013.9939 #_last_yr_fullbias_adj_in_MPD
2014.0939 #_end_yr_for_ramp_in_MPD (can be in forecast to shape ramp, but SS sets bias_adj to 0.0 for fcast yrs)
0.9409 #_max_bias_adj_in_MPD (-1 to override ramp and set biasadj=1.0 for all estimated recdevs)

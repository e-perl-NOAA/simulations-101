...
#C file write time: 2024-02-22 17:05:23.678199
#
...
#_Yr Input_value
1970  0.795935939059347 #_stochastic_recdev_with_sigmaR=0.5
1971 -0.0358902435277221 #_stochastic_recdev_with_sigmaR=0.5
1972  1.08544678335759 #_stochastic_recdev_with_sigmaR=0.5
1973  0.406737960764071 #_stochastic_recdev_with_sigmaR=0.5
1974 -0.234794291419441 #_stochastic_recdev_with_sigmaR=0.5
1975 -0.316472162242269 #_stochastic_recdev_with_sigmaR=0.5
1976 -0.0589846569340486 #_stochastic_recdev_with_sigmaR=0.5
1977  0.378997356356486 #_stochastic_recdev_with_sigmaR=0.5
1978 -0.622507334944198 #_stochastic_recdev_with_sigmaR=0.5
1979 -0.261437592850418 #_stochastic_recdev_with_sigmaR=0.5
1980  0.152409152367691 #_stochastic_recdev_with_sigmaR=0.5
1981 -0.426067039870371 #_stochastic_recdev_with_sigmaR=0.5
1982  0.0145120673130257 #_stochastic_recdev_with_sigmaR=0.5
1983 -0.512265664759876 #_stochastic_recdev_with_sigmaR=0.5
1984 -0.957275245832911 #_stochastic_recdev_with_sigmaR=0.5
1985  0.267590602316624 #_stochastic_recdev_with_sigmaR=0.5
1986 -0.0656832286719859 #_stochastic_recdev_with_sigmaR=0.5
1987  0.53048345052439 #_stochastic_recdev_with_sigmaR=0.5
1988 -0.0910749448173926 #_stochastic_recdev_with_sigmaR=0.5
1989 -0.533664376921971 #_stochastic_recdev_with_sigmaR=0.5
1990 -0.0755390470596925 #_stochastic_recdev_with_sigmaR=0.5
1991  0.617225100113159 #_stochastic_recdev_with_sigmaR=0.5
1992 -0.0579570201079321 #_stochastic_recdev_with_sigmaR=0.5
1993 -0.625620273733953 #_stochastic_recdev_with_sigmaR=0.5
1994  0.568581449749882 #_stochastic_recdev_with_sigmaR=0.5
1995  0.264923140583312 #_stochastic_recdev_with_sigmaR=0.5
1996 -0.45027998011143 #_stochastic_recdev_with_sigmaR=0.5
1997  0.282842265181892 #_stochastic_recdev_with_sigmaR=0.5
1998  0.0307020751938326 #_stochastic_recdev_with_sigmaR=0.5
1999  0.664724798934006 #_stochastic_recdev_with_sigmaR=0.5
2000 -0.763419467934927 #_stochastic_recdev_with_sigmaR=0.5
2001 -0.207028278612979 #_stochastic_recdev_with_sigmaR=0.5
2002  0.523688436202081 #_stochastic_recdev_with_sigmaR=0.5
2003 -0.196714301956753 #_stochastic_recdev_with_sigmaR=0.5
2004  0.392610223835219 #_stochastic_recdev_with_sigmaR=0.5
2005  0.604676790254706 #_stochastic_recdev_with_sigmaR=0.5
2006 -0.0314543570078709 #_stochastic_recdev_with_sigmaR=0.5
2007 -1.05795808278917 #_stochastic_recdev_with_sigmaR=0.5
...
#_LO	HI	INIT	PRIOR	PR_SD	PR_type	PHASE	env-var	use_dev	dev_mnyr	dev_mxyr	dev_PH	Block	Blk_Fxn  #  parm_name
-15	15	 -0.86533	0	1	0	-1	0	0	0	0	0	0	0	#_LnQ_base_Shallow_Survey(3)
-15	15	 0.382872	0	1	0	-1	0	0	0	0	0	0	0	#_LnQ_base_Middle_Survey(4) 
-15	15	-0.388203	0	1	0	-1	0	0	0	0	0	0	0	#_LnQ_base_Deep_Survey(5)   

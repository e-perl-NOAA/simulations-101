...
1964.0093 #_last_yr_nobias_adj_in_MPD; begin of ramp
1973.8583 #_first_yr_fullbias_adj_in_MPD; begin of plateau
2016.757 #_last_yr_fullbias_adj_in_MPD
2017.0614 #_end_yr_for_ramp_in_MPD (can be in forecast to shape ramp, but SS sets bias_adj to 0.0 for fcast yrs)
0.8656 #_max_bias_adj_in_MPD (-1 to override ramp and set biasadj=1.0 for all estimated recdevs)
...
#_LO	HI	INIT	PRIOR	PR_SD	PR_type	PHASE	env-var	use_dev	dev_mnyr	dev_mxyr	dev_PH	Block	Blk_Fxn  #  parm_name
 -15	 15	 2.56515	     0	  1	0	-1	0	0	0	0	0	0	0	#_LnQ_base_Acoustic_Survey(2) 

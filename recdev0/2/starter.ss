...
#C file write time: 2023-05-03 11:40:44.41973
data.ss
control.ss
...
#
7 # Number of datafiles to produce:  0 turns off all *.ss_new; 1st is data_echo.ss_new, 2nd is data_expval.ss, 3rd and higher are data_boot_**N.ss,
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1683134675
